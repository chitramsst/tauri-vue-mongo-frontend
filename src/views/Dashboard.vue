<template lang="">
  <div class="w-screen mx-auto flex flex-row">
    <div
    ...
    >
      ...
      >
        ...
        <span class="flex items-center justify-center h-full">Product</span></a
      >
      <a
        href="#"
        class="p-4 text-white hover:bg-gray-700 font-bold text-md flex flex-row justify-left items-center space-x-5"
      >
        ...
        <span class="flex items-center justify-center h-full">Logout</span></a
      >
    </div>
    <div
      class="w-full text-black fixed"
    ...
    >
      ...
      <div class="h-screen bg-white rounded-lg p-5 w-full"></div>
    </div>
  </div>
</template>
<script>
