<template lang="">
  <div>
    <div class="w-full bg-black h-9 px-36 flex items-center">
      <div class="flex w-full justify-between items-center">
        ...
        <div class="flex gap-2 text-xm font-semibold items-center">
          Black Friday Deals Here! 30-40%
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
            class="w-4 h-4 stroke-2ß"
          >
            <path
              fill-rule="evenodd"
    ...
    <div class="w-full px-36 h-full">
      <div
        class="w-full h-[37rem] bg-white shadow-2xl rounded-3xl p-12 text-black flex gap-2"
      >
        <div class="w-1/2 h-full py-7">
          <div class="text-5xl font-extrabold tracking-wide leading-snug w-96">
            Buy This Now Become Shining
          </div>
          <p class="w-96 mt-3 mb-10">
            Reference site about Lorem Ipsum, giving information on its origins,
            as well as a random Lipsum generator.
          </p>
          <div class="">
            <button class="bg-[#FF9494] px-4 py-2 rounded-full">
      ...
      <div class="h-[20%] my-20 w-full">
        <div
          class="text-black text-xl font-bold flex items-center justify-center"
        >
          Trending Searches
        </div>
        <div class="flex items-center justify-center mx-12 my-7 gap-2">
          <span
            class="rounded-3xl border-[1px] text-black border-gray-300 px-5 py-1 font-medium"
          >
            T shirt
          </span>
          <span
    ...
    <div class="px-36 mt-[200px] py-28">
      ...
      <div class="grid grid-cols-4 my-7 gap-7">
        <div class="bg-white rounded-lg flex items-center justify-center">
            ...
            <g transform="translate(-9.6659 -106.33)">
              ...
              >
                <g transform="matrix(1.4354 0 0 1.4355 -242.08 -126.56)">
                  ...
                  <g fill="#fff">
                    <path
                      d="m637.87 362.27h-8.221c-0.352 0-0.637-0.28-0.637-0.625v-37.509c0-0.342 0.285-0.622 0.637-0.622h8.221c0.349 0 0.638 0.28 0.638 0.622v37.509c0 0.345-0.289 0.625-0.638 0.625"
                    />
                    <path
                    ...
                    />
                    <path
                      d="m604.04 347.33h-8.633c-0.352 0-0.641-0.28-0.641-0.623v-22.574c0-0.341 0.289-0.621 0.641-0.621h8.633c0.349 0 0.635 0.28 0.635 0.621v22.574c0 0.343-0.286 0.623-0.635 0.623"
                    />
                  </g>
                </g>
              </g>
          ...
          <div class="flex m-5 justify-between">
            <div class="flex flex-col">
              <span class="text-black text-lg font-bold"> Xiamoi </span>
              <div class="flex gap-4">
    ...
    <div class="bg-white">
      <div class="px-36 mt-[10px] py-5">
        <div class="grid grid-cols-4 my-7 gap-7">
          ...
          <div class="bg-white rounded-lg flex items-center justify-center">
            <svg class="h-20 w-20 rounded-full bg-[#F6AD54]/30 p-5 stroke-[1px]" height="200px" width="200px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#dd7d08" stroke="#dd7d08"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M294.395,511.985c0,0-38.767-75.63,35.783-127.996s95.453-81.429,95.453-81.429s41.743-11.632,23.855,23.271 c-12.001,22.282-28.2,42.03-47.702,58.159c0,0,56.654-11.632,71.566-58.174s0-72.717,35.783-81.446c0,0,17.888,87.262-35.783,139.62 s-116.293,72.716-119.277,127.995H294.395z"></path> <path d="M217.597,511.985c0,0,38.767-75.63-35.783-127.996S86.361,302.56,86.361,302.56S44.61,290.92,62.506,325.831 c12.001,22.282,28.2,42.03,47.702,58.159c0,0-56.654-11.624-71.558-58.159s0-72.717-35.783-81.446c0,0-17.888,87.262,35.783,139.62 S154.944,456.723,157.927,512L217.597,511.985z"></path> <circle style="fill:#F6AD54;" cx="256" cy="159.664" r="159.664"></circle> <path style="fill:#F6AD54FFFFFF;" d="M246.764,251.433v-23.199c-13.607-0.153-26.95-3.773-38.767-10.519l6.455-22.48 c11.306,6.696,24.165,10.322,37.303,10.519c15.064,0,25.351-7.415,25.351-18.888c0-10.76-8.376-17.696-26.071-24.151 c-25.111-9.088-41.366-20.568-41.366-42.807c0-20.559,14.343-36.343,38.503-40.655V55.822h19.608v22.239 c11.452,0.127,22.728,2.822,32.999,7.888l-6.455,21.999c-10.036-5.266-21.185-8.056-32.519-8.135 c-16.744,0-22.72,8.608-22.72,16.736c0,9.808,8.608,15.303,28.935,23.44c26.783,10.04,38.735,22.959,38.735,44.238 c0,20.327-14.111,38.262-40.414,42.567v24.639h-19.576V251.433z"></path> </g></svg>
            <div class="flex m-5 justify-between">
              <div class="flex flex-col">
          ...
          <div class="bg-white rounded-lg flex items-center justify-center">
            ...
            <svg  class="h-20 w-20 rounded-full bg-[#A049CE]/20 p-5 stroke-[1px]" fill="#A049CE" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 471.817 471.817" xml:space="preserve" stroke="#A049CE"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M434.717,123.98c0-22.231-18.021-40.251-40.251-40.251H40.251C18.021,83.729,0,101.75,0,123.98v35.247h434.717V123.98 L434.717,123.98z"></path> <path d="M402.391,253.235c-0.978-0.978-2.56-0.978-3.535,0l-38.537,38.535l-15.392-15.39c-0.938-0.938-2.598-0.938-3.534,0 l-14.144,14.144c-0.469,0.469-0.731,1.104-0.731,1.768s0.264,1.299,0.731,1.768l31.301,31.299 c0.488,0.488,1.127,0.732,1.769,0.732c0.639,0,1.279-0.244,1.768-0.732l54.447-54.445c0.469-0.469,0.732-1.104,0.732-1.769 c0-0.663-0.265-1.299-0.732-1.769L402.391,253.235z"></path> <path d="M372.023,188.502c-18.222,0-35.312,4.912-50.029,13.475H0v122.11c0,22.229,18.021,40.251,40.251,40.251h267.227 c17.414,14.805,39.954,23.75,64.547,23.75c55.025,0,99.793-44.766,99.793-99.793C471.816,233.269,427.05,188.502,372.023,188.502z M148.392,309.309c0,2.852-2.313,5.164-5.164,5.164H63.604c-2.852,0-5.165-2.312-5.165-5.164v-15.71 c0-2.853,2.313-5.165,5.165-5.165h79.624c2.852,0,5.164,2.312,5.164,5.165V309.309L148.392,309.309z M372.023,351.547 c-34.935,0-63.251-28.318-63.251-63.251s28.316-63.25,63.251-63.25c34.933,0,63.25,28.318,63.25,63.25 S406.956,351.547,372.023,351.547z"></path> </g> </g> </g></svg>
            <div class="flex m-5 justify-between">
              <div class="flex flex-col">
